    ...
    <div className="page-enter mx-auto flex min-h-[100dvh] max-w-[390px] flex-col justify-center px-4">
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-lg">
        ...
        <div className="mt-4 flex flex-col gap-2">
          <Link
            to="/app"
            className="interactive-button block rounded-xl bg-primary py-3 text-center text-sm font-semibold text-white"
          >
            Go to student app
          </Link>
          <button
            type="button"
            onClick={() => signOut()}
            className="interactive-button rounded-xl border border-slate-200 py-3 text-sm font-medium text-slate-700"
          >
            Sign out
          </button>
        </div>
